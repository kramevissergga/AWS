(() => {
    ...
    if (document.querySelector(".about-slider")) {
        var aboutSliderThumb = new Swiper(".about-slider-thumb", {
            slidesPerView: "auto",
            freeMode: true,
            watchSlidesProgress: true
        });
        new Swiper(".about-slider", {
            ...
            thumbs: {
                swiper: aboutSliderThumb
            }
        });
    }
    const slides = document.querySelectorAll(".about-slider-thumb .swiper-slide");
    slides.forEach(((slide, index) => {
        const formattedIndex = (index + 1).toString().padStart(3, "0");
        slide.setAttribute("data-index", formattedIndex);
    }));
    ...
    servicesItems.forEach((item => {
        item.addEventListener("mouseenter", (function() {
            ...
            servicesImage.setAttribute("src", newSrc);
        }));
    }));
    if (document.querySelector(".cube-slider")) {
        const sliders = document.querySelectorAll(".cube-slider");
        sliders.forEach((slider => {
            const prevButtons = slider.querySelectorAll(".cube-slider__button--prev");
            const nextButtons = slider.querySelectorAll(".cube-slider__button--next");
            ...
            new Swiper(slider, {
                ...
                on: {
                    ...
                    slideChangeTransitionStart: function() {
                        slider.classList.remove("dir-left", "dir-right");
                        if (this.activeIndex > this.previousIndex && this.activeIndex < this.slides.length - 1) slider.classList.add("dir-right"); else if (this.activeIndex < this.previousIndex && this.activeIndex > 0) slider.classList.add("dir-left");
                        this.previousIndex = this.activeIndex;
                    },
                    slideChangeTransitionEnd: function() {
                        if (this.activeIndex === 0 || this.activeIndex === this.slides.length - 1) slider.classList.remove("dir-left", "dir-right");
                    }
                }
            });
        }));
